...
const subPrograms = [
  {
    ...
    description: "Accredited academic school running from Nursery through Senior High (Grade 11), located at the SHIFSD Multipurpose Youth Training Center in Johnsonville, Montserrado County.",
  ...
  },
  {
    ...
    description: "Supported by Mission Alliance, this program uses a hybrid methodology to deliver adult literacy education across 30 communities in the Zorzor & Salayea Districts of Lofa County, empowering adults to participate more fully in their communities.",
